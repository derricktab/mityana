...
if($_GET){
    ...
    $sql = "DELETE FROM subject_offered WHERE student = '$id'";
    ...
    if($ex){ error_reporting(E_ALL); ini_set('display_errors', 1); ?>
        <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Student ('<?php echo substr($name,0,40) ?>') - ID : ('<?php echo substr($id, 0, 40) ?>') has been unenrolled successfully
    ...
    <?php }else{ ?>
        ...
        <center>
            ...
            <a class="close" href="subjects.php">&times;</a>
            <div class="content">
                Student ('<?php echo substr($name,0,40) ?>') - ID : ('<?php echo substr($id, 0, 40) ?>') unenrollment unsuccessful
