...
(gj.widget = function () {
    ...
    (gj.datepicker.config = {
        base: {
            ...
            locale: "en-us",
            icons: { rightIcon: '<i class="fa fa-calendar-days"></i>', previousMonth: '<i class="fa fa-chevron-left"></i>', nextMonth: '<i class="fa fa-chevron-right"></i>' },
            fontSize: void 0,
            size: "default",
            modal: !1,
            header: !1,
    ...
    (gj.colorpicker.config = {
        base: {
            uiLibrary: "materialdesign",
            value: void 0,
            icons: { rightIcon: '<i class="fa fa-calendar"></i>' },
